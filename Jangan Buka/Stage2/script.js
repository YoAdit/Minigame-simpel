...
function checkGameOver() {
    if (playerHealth <= 0) {
        ...
        window.location.href = '../transition/transition3.html';
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    "Pahlawan yang dipanggil oleh tuan putri👸,muhahaha😈",
    "Jangan berharap kau bisa bertemu dengan boss😈",
    "Karena, aku Red Devil 😈",
    "Yang akan mengalahkan mu terlebih dahulu😈",
    "Muhahaha😈",
    ];
